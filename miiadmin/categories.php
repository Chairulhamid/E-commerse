...
<head>
	...
	<title>Nayya Humam Store | Kategori</title>
	...
	<div id="wrapper">
			...
			<ul class="sidebar-nav">
				...
				<li class="sidebar-child"><a href="#"><i class="fa fa-th"></i> Data Produk <i class="sidebar-fa fa fa-angle-down pull-right"></i></a>
					<ul class="sidebar-second-child" style="display:block;">
						...
						<li  class="active" ><a href="categories.php">Kategori Produk</a></li>
		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 style="color: black;" ><center>Data Kategori</center></h1>
		...
		?>
									<tr>
										...
										<td width="50" align="center">
											<a class="btn btn-info" href="?act=edit&id=<?php echo $row['cat_id']; ?>" class="mybtn"><i class="fa fa-pencil-square-o"></i></a>
										</td>
										<td width="50" align="center">
											<a class="btn btn-danger" href="<?php echo $row['cat_id']; ?>" data-target="#confirm-delete_<?php echo $row['cat_id']; ?>" data-toggle="modal" class="mybtn btn-show"><i class="fa fa-trash-o"></i></a>
		...
		<?php
							...
							if(isset($_POST['save'])){
								$query = mysqli_query($conn,"SELECT * FROM categories WHERE category='".$_POST['nama_kategori']."'");
								...
								if($_SERVER['REQUEST_METHOD'] == "POST"){	
									if(empty($_POST['nama_kategori'])){
										...
										if(!preg_match("/^[a-zA-Z ]*$/",$_POST['nama_kategori'])){
											$error = true;
		...
		?>
						...
						<form action="?act=add" class="form-horizontal" method="POST">
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<input type="text" name="nama_kategori" placeholder="Masukkan nama kategori" class="form-control" value="<?php echo isset($category) ? $category : ' ';?>">
							...
							<div class="form-group">
								...
								<div class="text-right col-md-10">
									...
									<a href="categories.php"><button type="button" class="btn btn-danger">Kembali</button></a>
								</div>
							</div>	
						</form>
					</div>
					...
					if(isset($_POST['update'])){
						...
						if($_SERVER['REQUEST_METHOD'] == "POST"){
							if(empty($_POST['nama_kategori'])){
								...
								$category = mysqli_real_escape_string($conn,$_POST['nama_kategori']);
								if(!preg_match("/^[a-zA-Z ]*$/",$_POST['nama_kategori'])){
									$error = true;
		...
		?>
						<form action="?act=edit&id=<?php echo $_GET['id'];?>" class="form-horizontal" method="POST">
							...
							<div class="form-group">
								<label class="col-md-2 control-label">Nama Kategori </label>
								<div class="col-md-10">
									<input type="text" name="nama_kategori" value="<?php echo isset($_POST['nama_kategori']) ? $_POST['nama_kategori'] : $data['category']; ?>" class="form-control">
