...
<head>
	...
	<title>Nayya Humam Store | Data Penjualan Produk </title>
				...
				<div class="row">
					<div class="col-lg-12">
						<form action="order_report_bydate.php" class="form-horizontal" method="POST">
								<legend><h1 style="color: black;" ><center>Laporan Data Pemesanan Produk berdasarkan Tanggal</h1></legend>
							<h4>Pencarian data menurut Dari:</h4>
							<!-- Tanggal Awal -->
							<div class="form-group">
								<label class="col-md-3 control-label">Pilih Tanggal Awal</label>
								<div class="col-md-6">
							...
							<!-- Tanggal Akhir -->
							<div class="form-group">
								<label class="col-md-3 control-label">Pilih Tanggal Akhir</label>
								<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<input type="submit" class="btn btn-success" name="find" value="Cari">
						...
						<div class="orderbydate">
							<div class="col-lg-12" style="margin-top: -5%;">
								<button type="button" class="btn btn-warning" onclick="window.open('pdf/date_order_report_bypdf.php?tgl1=<?php echo $_POST['date1']; ?>&tgl2=<?php echo $_POST['date2']; ?>');"> Lihat PDF</button>
							</div>
							<div id="divToPrint">
								<div class="table-responsive">
									<table  class="table table-bordered table-striped results border border-dark">
