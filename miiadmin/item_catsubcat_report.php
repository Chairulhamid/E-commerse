				...
				<div class="row">
					<div class="col-lg-12">
						<form class="form-horizontal">
							<legend><h1 style="color: black;" ><center>Laporan Data Produk Berdasarkan Kategori dan Subkategori</h1></legend>
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<button class="btn btn-danger" id="resetcatsubcat">Reset</button>
								</div>
							</div>
						</form>
