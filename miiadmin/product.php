...
<head>
	...
	<title>Nayya Humam Store | Data ALL Produk </title>
	...
	<div id="wrapper">
			...
			<ul class="sidebar-nav">
				...
				<li class="sidebar-child"><a href="#"><i class="fa fa-th"></i>Data Produk <i class="sidebar-fa fa fa-angle-down pull-right"></i></a>
					<ul class="sidebar-second-child" style="display:block;">
						...
						<li><a href="subcategories.php">Sub Kategori Product</a></li>
						<li><a href="colors.php">Warna Produk</a></li>
						<li class="active"><a href="product.php">Data ALL Produk</a></li>
					</ul>
				</li>
		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 style="color: black;" ><center>Data ALL Produk</center></h1>
		...
		?>
									<tr>
										...
										<td width="50" align="center">
											<a class="btn btn-info" href="?act=edit&id=<?php echo $row['item_id']; ?>" class="mybtn"><i class="fa fa-pencil-square-o"></i></a>
										</td>
										<td width="50" align="center">
											<a class="btn btn-danger" href="<?php echo $row['item_id']; ?>" data-target="#confirm-delete_<?php echo $row['item_id']; ?>" data-toggle="modal" class="mybtn btn-show"><i class="fa fa-trash-o"></i></a>
		...
		?>
						...
						<form action="?act=add" class="form-horizontal" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<input type="text" name="item" class="form-control" placeholder="Masukkan nama Produk" value="<?php echo isset($item) ? $item : ' ';?>">
							...
							<div class="form-group">
								...
								<label class="col-md-2 control-label">Pilih Jenis Sub kategori</label>
								<div class="col-md-3">
									<select name="scat_id" id="subcat" class="form-control">
										<option value="blank">== Pilih jenis sub kategori ==</option>
										<?php
										$query = mysqli_query($conn, "SELECT * FROM subcategories ORDER BY subcategory ASC");
										while($catid = mysqli_fetch_array($query)){
										?>
											<option <?php if($cat == $catid['scat_id']) echo 'selected' ; ?> value="<?php echo $catid['scat_id']; ?>"><?php echo $catid['subcategory']; ?></option>
										<?php
										}
										?>
									</select>
							...
							<div class="form-group">
								<label class="col-md-2 control-label">Pilih Gambar Utama</label>
								<div class="col-md-10">
							...
							<!-- Stok Produk -->
							<div class="form-group">
								<label class="col-md-2 control-label">Jumlah Produk</label>
								<div class="col-md-2">
							...
							<div class="form-group">
								...
								<div class="text-center col-md-10">
									<button type="submit" class="btn btn-block btn-success" name="save"><b>Simpan</b></button><br>
									<a href="product.php"><button type="button" class="btn btn-block btn-danger"><b>kembali</b></button></a>
								</div>
							</div>	
						</form>
					</div>
		...
		?>
						<form action="?act=edit&id=<?php echo $_GET['id'];?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<label class="col-md-2 control-label">Tipe Sub kategori</label>
								<div class="col-md-3">
									<select name="scat_id" id="subcat" class="form-control">
							...
							<!-- Pilihan Brand -->
							<div class="form-group">
								<label class="col-md-2 control-label">Pilih Tipe Merek</label>
								<div class="col-md-10">
									<select name="brand" class="form-control">
										<option value="blank">-- Pilih tipe brand--</option>
										<?php
							...
							<div class="form-group">
								<label class="col-md-2 control-label"></label>
								<div class="col-md-10">
									<button type="submit" class="btn btn-block btn-success" name="update"><b>Update</b></button><br>
									<a href="product.php"><button type="button" class="btn btn-block btn-danger"><b>Kembali</b></button></a>
								</div>
							</div>
						</form>
