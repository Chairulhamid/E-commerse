...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				<div class="row">
						<legend><h1 style="color: black;" ><center>Laporan Data Produk </h1></legend>
					<div class="col-lg-12">
						<button class="btn btn-warning" type="button"  onclick="window.open('pdf/item_report_bypdf.php');"> Lihat PDF</button>
						<div><br>
