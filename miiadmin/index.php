...
<head>
	...
	<title>Nayya Humam Store | Login Admin</title>
...
<body class="background-black">
	...
	<div class="container">
		<div class="row">
			<div style="margin-top:-50px" class="col-sm-6 col-md-4 col-md-offset-4">
				<!-- Logo -->
				<h1 style="color: white;font-family: 'Creepster', cursive;"><center>login Admin</center></h1>
				<h1 style="color: gold;font-family: 'Creepster', cursive; font-size:50px;"><center>Nayya Humam</center></h1>
				<h1 style="color: gold;font-family: 'Creepster', cursive;"><center>Store</center></h1>
								...
								if(mysqli_num_rows($login) > 0){
									while($row=mysqli_fetch_assoc($login)){
										...
										if($loginok == TRUE){
											...
											$error = true;
											echo "<div class='alert alert-danger'>Nama pengguna atau kata sandi Anda salah, silakan coba lagi!</div>";
										}
									}
								}else{
									$error = true;
				...
				?>
					<form action="index.php" method="post">
						<div class="form-group input-group groups">
							...
							<input type="text" class="form-control form-input" name="username" placeholder="Masukkan nama pengguna">
						</div>
						...
						<button type="submit" class="btn btn-lg btn-primary btn-block" name="signin">Masuk</button> <br>
						<p style="color: white;">Belum Punya Akun?</p>
						<a href="?signup"><button type="button" class="btn btn-lg btn-success btn-block">Daftar Akun</button></a>
					</form>
				</div>
	...
	<div class="container">
		<div class="row">
			<div style="margin-top:-50px" class="col-sm-6 col-md-4 col-md-offset-4">
				<!-- Logo -->
				<h1 style="color: white;font-family: 'Creepster', cursive;"><center>Daftar Akun</center></h1>
				<h1 style="color: gold;font-family: 'Creepster', cursive; font-size:50px;"><center>Nayya Humam</center></h1>
				<h1 style="color: gold;font-family: 'Creepster', cursive;"><center>Store</center></h1>
				<!-- Form -->
				...
				<form action="?signup" method="post">
						<div class="form-group input-group groups">
							<span class="input-group-addon icons"><i class="fa fa-user"></i></span>
							<input type="text" class="form-control form-input" name="fullname" placeholder="Masukkan nama lengkap">
						</div>
						<span class="text-danger msg-error"><?php echo $nameErr; ?></span>
						
						<div class="form-group input-group groups">
							<span class="input-group-addon icons"><i class="fa fa-user"></i></span>
							<input type="text" class="form-control form-input" name="user" placeholder="Masukkan  nama pengguna">
						</div>
						<span class="text-danger msg-error"><?php echo $userErr; ?></span>
						...
						<button type="submit" class="btn btn-lg btn-primary btn-block" name="signup">Daftar Akun</button>
					</form>
					<p style="color: white;" class="">Pernah jadi anggota?</p>
					<a href="./index.php"><button type="button" class="btn btn-lg btn-info btn-block">Login</button></a>
				</div>
			</div>
		</div>
	</div>
