...
if(@$_GET){
	switch($_GET['p']){
		...
		break;
		case "sweeters";
			include "subkat/sweeters.php";
		break;
		case "suits";
			include "subkat/suits.php";
		break;
		case "jeans";
			include "subkat/jeans.php";
		break;
		case "shorts";
			include "subkat/shorts.php";
		break;
		case "formaltrousers";
			include "subkat/formaltrousers.php";
		break;
		case "casualtrousers";
			include "subkat/casualtrousers.php";
		break;
		case "tshirt";
		...
		break;
		case "formalshirt";
			include "subkat/formal_shirts.php";
		break;
		case "jackets";
