<div class="container">
	<h1 class="well"><center>Pendaftaran Akun Nayya Humam Store</center></h1>
				...
				<div class="col-sm-12">
					<div class="row">
						<div class="col-sm-12 form-group">
							...
							<input type="text" class="form-control" name="fname" placeholder="Masukan  nama Anda" value="<?php echo isset($fname) ? $fname : ' ';?>">
							<span class="text-danger msg-error"><?php echo $fnameErr; ?></span>
						</div>
							
						<div class="col-sm-12 form-group">
							<label>Nama Terakhir :</label>
							<input type="text" class="form-control" name="lname" placeholder="Masukan  nama Anda" value="<?php echo isset($lname) ? $lname : ' ';?>">
					...
					<div class="row">
						<div class="col-sm-6 form-group">
							...
							<input type="text" class="form-control" name="city" placeholder="Masukan nama kota atau kabupaten" value="<?php echo isset($city) ? $city : ' ';?>">
							<span class="text-danger msg-error"><?php echo $cityErr; ?></span>
						</div>
							
						<div class="col-sm-6 form-group">
							<label>Provinsi :</label>
							<input type="text" class="form-control" name="state" placeholder="Masukan provinsi" value="<?php echo isset($state) ? $state : ' ';?>">
					...
					<div class="row">
						<div class="col-sm-4 form-group">
							...
							<input type="text" class="form-control" name="email" placeholder="Masukan alamat email" value="<?php echo isset($email) ? $email : ' ';?>">
					...
					<center>
						<div class="form-group">
							<button type="submit" class="btn btn-success" name="signup">Daftar</button>
	...
	<div class="well"><p class="text-center new-account">Sudah Memiliki Akun??? <a href="./index.php?p=login">Masuk</a></p></div>
</div>