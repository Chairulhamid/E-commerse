<div class="container">
	<div class="row">
		<div class="col-lg-12">
			<h2 class="text-center text1">Konfirmasi Pembayaran Anda</h2>
		</div>
		<?php
		...
		<form action="./index.php?p=checkout" class="form-horizontal" method="POST">
			...
			<legend>Metode Pembayaran Anda</legend>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="col-md-2 control-label">Nomor Rekening Anda</label>
				<div class="col-md-9">
					<input type="text" name="card_number" id="card_number" class="form-control" placeholder="Masukan Nomor Rekening Bank Anda"  value="<?php echo isset($cardnumber) ? $cardnumber : ' ';?>">
					<span class="text-danger msg-error"><?php echo $cardnumberErr; ?></span>
				</div>
			</div>
			<legend>Ringkasan Pembayaran</legend>
			<div class="form-group">
				<label class="col-md-2 control-label">Total transaksi Belanja</label>
				<div class="col-md-3">
			...
			<div class="form-group">
				<label class="col-md-2 control-label">Jumlah Bayar Belanja Anda</label>
				<div class="col-md-2">
			...
			<center>
				<div class="form-group">
					<button type="submit" class="btn btn-success btn-block" name="checkout">Bayar Sekarang</button><br>
					<a href="./index.php"><button type="button" class="btn btn-danger btn-block">Batal</button></a>
				</div>
			</center>
		</form>
		</div>
