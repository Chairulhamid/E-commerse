...
<div class="product-detail">
	<div class="container">
		<div class="col-lg-12">
			...
			?>
			<div class="back-left"><a class=" btn btn-danger" href="./index.php"><i class="fa fa-arrow-left"></i> Kembali</a></div>
			<br><br>
			...
			<form action="./index.php?p=single&id=<?php echo $_GET['id']; ?>" method="POST">
				...
				<input style="color: black;" type="submit" name="cart" value="Beli sekarang" class="btn-checkout-2 btn-warning">
				</form>
